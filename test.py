...
grafos_variables_greedy = ["rel_chico.corr",
          "queen13.corr",
          "queen10.corr",
          "school1.corr",
          "greedy_42.corr",
...
grafos_bipartitos = ["bipartito_6.corr",
                     "b_5576.corr",
                     "b_20002.corr",
                     "b_20482.corr",
                     "b_millon.corr"
                     ]
grafos_memoria = ["mem_3080.corr",
                  "mem_2210104.corr",
                  "mem_importante.corr",
                  "mem_221561.corr",
                  "mem_23658.corr",
...
def probar_implementacion(graph_file):
    ...
    cmd = "./grafo < {} > {}".format(graph_file, "reordenes.md") #si es de a muchos,
