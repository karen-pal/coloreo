...
// Grafo es un puntero a una estructura, la cual esta definida en el .h de
// arriba
...
// las otras no hay problema pues es imposible que (2 a la 32)-1 sea un color o
// un grado.
...
// ordena por cardinalidad de los bloques de colores, del mas chico al mas
// grande
